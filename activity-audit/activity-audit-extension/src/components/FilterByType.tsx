...
const FilterByType = ({filterBy, handleFilter, resetFilterBy}:FilterByTypeProps) => {
    ...
    return(
        <Flex justify="space-between" align="center" style={{ width: "100%" }}>
            <h4 style={{ marginLeft: "50px", color: "#171a1f", fontWeight: 400, fontSize: 16 }}>Draft Activity</h4>
