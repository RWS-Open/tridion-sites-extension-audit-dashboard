...
export default env => ({
    ...
    output: {
        ...
        path: resolve(dirname(fileURLToPath(import.meta.url)), '../dist/activity-audit-extension'),
        publicPath: `${extensionsRequestBasePath}/activity-audit-extension/dist/activity-audit-extension`,
        clean: true,
    },
